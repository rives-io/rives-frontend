      ...
      <div className='flex flex-wrap justify-evenly items-center'>
        ...
        <div className='flex flex-col items-center gap-2'>
          <div className='flex gap-1 items-center'>
            <Link href={"https://discord.gg/FQnQqKWVn8"} className='hover:text-rives-purple'><DiscordLogo /></Link>
            <Link href={"https://twitter.com/rives_io"} className='h-6 hover:text-rives-purple'><XIcon /></Link>
