...
export const models: Models = {
    'IndexerPayload': {
        ...
        validator: ajv.compile<ifaces.IndexerPayload>(JSON.parse('{"title": "IndexerPayload", "type": "object", "properties": {"tags": {"title": "Tags", "type": "array", "items": {"type": "string"}}, "type": {"title": "Type", "type": "string"}, "msg_sender": {"title": "Msg Sender", "type": "string"}, "timestamp_gte": {"title": "Timestamp Gte", "type": "integer"}, "timestamp_lte": {"title": "Timestamp Lte", "type": "integer"}, "module": {"title": "Module", "type": "string"}, "input_index": {"title": "Input Index", "type": "integer"}, "dapp_address": {"title": "Dapp Address", "type": "string"}, "order_by": {"title": "Order By", "type": "string"}, "order_dir": {"title": "Order Dir", "type": "string"}, "page": {"title": "Page", "type": "integer"}, "page_size": {"title": "Page Size", "type": "integer"}}}'))
    },
    'IndexerOutput': {
